...
namespace ATRCWEB.Reportes
{
    public partial class ConcentradoNomina : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public ConcentradoNomina(DateTime Inicial, DateTime Final)
        {
            ...
            XPCollection Usuarios = new XPCollection(ATRCBASE.BL.UtileriasXPO.ObtenerNuevaUnidadDeTrabajo(), typeof(CHECADOR.BL.UsuarioChecador), new NotOperator(new NullOperator("Usuario")));
