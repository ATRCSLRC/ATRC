...
namespace UNIDADES.BL.Clases
{
    [Persistent("Uni_HistorialExtintores")]
    public class HistorialExtintores : ATRCBase
    {
        public HistorialExtintores(Session session) : base(session) { }
