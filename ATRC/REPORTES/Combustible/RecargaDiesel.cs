...
namespace REPORTES.Combustible
{
    ...
    {
        public RecargaDiesel(DateTime De, DateTime Al)
        {
            InitializeComponent();
            ...
            XPView RecargasDiesel = new XPView(Unidad, typeof(COMBUSTIBLE.BL.RecargaDiesel), "Oid;FechaAlta;Tanque.Descripcion;Cantidad;PrecioLitro", go);
