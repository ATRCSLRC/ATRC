...
{
    public partial class RutasExtrasUsuario : DevExpress.XtraReports.UI.XtraReport
    {
        public UnidadDeTrabajo Unidad;
        DateTime DeInicio;
        DateTime AlFinal;
        public RutasExtrasUsuario(DateTime De, DateTime Al)
        {
            InitializeComponent();
            ...
            Tabla.DefaultView.RowFilter = "RutasLaboradas > 0";
        ...
        public static decimal HorasTrabajadas(UnidadDeTrabajo Unidad, int usuario, DateTime FechaInicial, DateTime FechaFinal)
        {
            ...
            goChoferEntrada.Operands.Add(new BinaryOperator("PagarChoferEntrada", true));
            ...
            goChoferSalida.Operands.Add(new BinaryOperator("PagarChoferSalida", true));
