...
namespace RUTAS.WIN
{
    public partial class xfrmAclaracionesCreadas : xfrmBase
    {
        public xfrmAclaracionesCreadas()
        {
            InitializeComponent();
        }

        private void xfrmAclaracionesCreadas_Load(object sender, EventArgs e)
        {
