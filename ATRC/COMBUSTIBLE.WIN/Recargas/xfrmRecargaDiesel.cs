...
namespace COMBUSTIBLE.WIN
{
    public partial class xfrmRecargaDiesel : xfrmBase
    {
        ...
        private void bbiTerminarRecarga_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            xfrmRecargasGRD xfrm = new xfrmRecargasGRD();
            xfrm.AgregarFinales = true;
            xfrm.ShowDialog();
        }
    }
}
