...
(function() {
    ...
    var endpointSelector = new DevExpress.EndpointSelector(Gasolina.config.endpoints);
    var serviceConfig = $.extend(true, {}, Gasolina.config.services, {
        db: {
    ...
    Gasolina.db = new DevExpress.data.ODataContext(serviceConfig.db);
