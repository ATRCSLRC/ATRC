...
(function() {
    ...
    var endpointSelector = new DevExpress.EndpointSelector(Inventarios.config.endpoints);
    var serviceConfig = $.extend(true, {}, Inventarios.config.services, {
        db: {
    ...
    Inventarios.db = new DevExpress.data.ODataContext(serviceConfig.db);
