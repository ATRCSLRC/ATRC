<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Aclaraciones.aspx.cs" Inherits="SolucionesATRC.Pedidos.Aclaraciones" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div id="MainPedido" class="col-12">
                <dx:BootstrapGridView ID="grdAclaraciones" ClientInstanceName="grdAclaraciones" OnDataBinding="grdPedidos_DataBinding" SettingsBehavior-AllowFocusedRow="true" OnCustomUnboundColumnData="grdPedidos_CustomUnboundColumnData" runat="server" AutoGenerateColumns="False">
