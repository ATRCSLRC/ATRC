<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="EventScheduling.aspx.cs" Inherits="SolucionesATRC.EventScheduling" %>
...
<asp:Content runat="server" ContentPlaceHolderID="mainContent">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server"
        DataObjectTypeName="SolucionesATRC.SchedulerAppointment"
        TypeName="SolucionesATRC.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server"
        DataObjectTypeName="SolucionesATRC.SchedulerResource"
        TypeName="SolucionesATRC.ResourceDataSourceHelper"
