...
{
    public partial class AclaracionesRecibidas : System.Web.UI.Page
    {
        ...
        protected void grdAclaraciones_DataBinding(object sender, EventArgs e)
        {
            if (Session["Unidad"] != null)
            {
                ...
                if (Unidad != null)
                {
                    ...
                    go.Operands.Add(new BinaryOperator("Estado", Enums.EstadoAclaraciones.Creado_Rutas));
                    go.Operands.Add(new BinaryOperator("Estado", Enums.EstadoAclaraciones.Revision_Maquiladora));
        ...
        protected void CallbackRechazar_Callback(object source, DevExpress.Web.CallbackEventArgs e)
        {
            if (Session["Unidad"] != null)
            {
