...
namespace Unidad.BL
{
    ...
    public class UtileriasXPO
    {
        ...
        public static string CadenaDeConexion = DevExpress.Xpo.DB.MSSqlConnectionProvider.GetConnectionString(@"192.168.1.65\ATRCSERVER", "sa", "@TRCSistemas1", "ATRCUnidades");
